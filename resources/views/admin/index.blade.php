        ...
        <div class="max-w-[1280px] mx-auto px-6 sm:px-8 lg:px-12">
            ...
            <div class="flex justify-between items-center mb-8">
                ...
                <div class="flex space-x-4">
                    <a href="{{ route('admin.medicines.create') }}" class="group bg-gradient-to-r from-teal-600 to-emerald-500 text-white font-medium py-2.5 px-5 rounded-lg shadow-lg hover:from-teal-700 hover:to-emerald-600 transform hover:-translate-y-0.5 transition-all duration-300 flex items-center">
            ...
            <div class="mb-8 bg-white rounded-xl shadow-lg p-6 border border-gray-100">
                <form action="{{ route('admin.index') }}" method="GET" class="flex items-center space-x-4">
                    ...
                    <button type="submit"
                            class="px-6 py-3 text-sm font-semibold text-white bg-gradient-to-r from-teal-600 to-emerald-500 hover:from-teal-700 hover:to-emerald-600 rounded-lg shadow-md hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-300">
                        検索
                    </button>
                </form>
            </div>
