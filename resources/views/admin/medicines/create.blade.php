<x-app-layout>
  <div class="min-h-screen bg-gray-50 py-6">
    <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
      ...
      <div class="overflow-hidden rounded-lg bg-white shadow-md">
        <!-- フォームの開始：商品登録用のフォーム -->
        <form class="p-6" action="{{ route("admin.medicines.store") }}" method="POST" enctype="multipart/form-data">
          @csrf <!-- CSRF対策のためのトークン -->
          ...
          <div class="mb-6">
            ...
            <p class="mt-1 text-xs text-gray-500">※入力必須</p>
          </div>
          ...
          <div class="mb-6">
            ...
            <div class="mt-1 flex items-center">
              <div
                class="mr-3 flex h-24 w-24 flex-shrink-0 items-center justify-center overflow-hidden rounded-md border border-gray-200 bg-gray-100">
                <svg class="h-10 w-10 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z">
                  </path>
                </svg>
                <img class="hidden h-full w-full object-cover" id="image-preview" src="#" alt="プレビュー">
              </div>
              <div class="flex-1">
                <input
          ...
          <div class="mb-6">
            <div class="mb-2 flex items-center justify-between">
              ...
              <button
                class="inline-flex items-center rounded-full bg-emerald-500 px-3 py-1.5 text-xs font-medium text-white transition-colors duration-200 hover:bg-emerald-600 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2"
          ...
          <div class="mb-6">
            <div class="mb-2 flex items-center justify-between">
              ...
              <button
                class="inline-flex items-center rounded-full bg-emerald-500 px-3 py-1.5 text-xs font-medium text-white transition-colors duration-200 hover:bg-emerald-600 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2"
                type="button" onclick="openCountryModal()">
                <svg class="mr-1 h-3 w-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                </svg>
                新しい国を追加
                  ...
                  <div class="{{ !$loop->last ? "border-b border-gray-200" : "" }} p-3">
                    <div class="mb-2 flex items-center">
                      <input class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"
                        id="country_{{ $country->id }}" name="countries[]" type="checkbox" value="{{ $country->id }}">
  ...
  <!-- 新しいカテゴリーを追加するモーダル -->
  <div class="fixed inset-0 hidden h-full w-full overflow-y-auto bg-gray-600 bg-opacity-50" id="categoryModal">
  ...
  <!-- 新しい国を追加するモーダル -->
  <div class="fixed inset-0 hidden h-full w-full overflow-y-auto bg-gray-600 bg-opacity-50" id="countryModal">
    <div class="relative top-20 mx-auto w-96 rounded-md border bg-white p-5 shadow-lg">
      <div class="mt-3">
        <h3 class="mb-4 text-lg font-medium text-gray-900">新しい国を追加</h3>
