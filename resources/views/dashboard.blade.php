    ...
    <x-slot name="header">
        <div class="flex items-center justify-between px-4 py-3">
            ...
            <nav class="hidden md:flex md:items-center md:space-x-6">
                <div class="text-slate-600 hover:text-teal-600 px-3 py-2 rounded-md text-sm font-medium transition-colors duration-300 cursor-pointer border-b-[3px] border-teal-600">ホーム</div>
                <div class="text-slate-600 hover:text-teal-600 px-3 py-2 rounded-md text-sm font-medium transition-colors duration-300 cursor-pointer border-b-[3px] border-transparent hover:border-teal-600">お気に入り</div>
                <div class="text-slate-600 hover:text-teal-600 px-3 py-2 rounded-md text-sm font-medium transition-colors duration-300 cursor-pointer border-b-[3px] border-transparent hover:border-teal-600">管理画面</div>
            </nav>
        </div>
    </x-slot>
        ...
        <main class="px-4 py-8">
            ...
            <section class="mb-12">
                <div class="text-center mb-8">
                    ...
                    <h2 class="text-3xl font-bold text-slate-800 mb-4">カテゴリや商品名から探す</h2>
                    <p class="text-xl text-slate-600 max-w-2xl mx-auto">検索方法を選んでください</p>
                </div>
                ...
                <div class="max-w-6xl mx-auto">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <a href="{{ route('medicines.category') }}" class="bg-white rounded-lg shadow-md overflow-hidden transform transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
                            ...
                            <div class="p-6">
                                <div class="w-14 h-14 rounded-full bg-gradient-to-br from-teal-100 via-white to-emerald-100 flex items-center justify-center mb-5 overflow-hidden shadow-[0_4px_16px_rgba(20,184,166,0.12)] ring-1 ring-teal-100/80">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-7 w-7 text-teal-600">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="m15.75 15.75-2.489-2.489m0 0a3.375 3.375 0 1 0-4.773-4.773 3.375 3.375 0 0 0 4.774 4.774ZM21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                                    </svg>
                                </div>
                                <h3 class="text-xl font-bold text-slate-800 mb-3">種類から検索</h3>
                                <p class="text-slate-600 mb-5">頭痛薬、風邪薬などカテゴリで薬を探せます。症状からぴったりの薬を見つけましょう。</p>
                        ...
                        <a href="{{ route('medicines.search') }}" class="bg-white rounded-lg shadow-md overflow-hidden transform transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
                            ...
                            <div class="p-6">
                                ...
                                <h3 class="text-xl font-bold text-slate-800 mb-3">商品名で検索</h3>
                                <p class="text-slate-600 mb-5">薬の名前がわかっている場合は、商品名で直接検索できます。正確かつ素早く薬を見つけられます。</p>
                                <div class="flex justify-center mb-4">
                            ...
                            <div class="flex flex-col md:flex-row items-center">
                                ...
                                <div class="w-full md:w-1/2 text-slate-800 z-10">
                                    <div class="flex items-center mb-4">
                                        ...
                                        <h2 class="text-xl font-bold text-slate-800 ml-4">位置情報ベースの検索</h2>
                                    </div>
                                    ...
                                    <div class="mb-6">
                                        <div class="inline-flex items-center bg-teal-100 bg-opacity-80 rounded-full py-1.5 px-3 mb-3">
                                            ...
                                            <p class="text-base font-medium text-slate-800" id="current-location">タイ, バンコク</p>
                                        </div>
                                        <p class="text-slate-600 text-base leading-relaxed">位置情報を有効にすると、現在いる国で販売されている薬だけを検索できます。旅行先でも地域に合った薬情報にアクセスできます。</p>
                                    </div>

                                    <button class="bg-gradient-to-r from-teal-600 to-emerald-500 text-white hover:from-teal-700 hover:to-emerald-600 font-medium py-2 px-4 rounded-lg text-sm transition-all duration-300 flex items-center justify-center shadow-lg hover:shadow-xl">
                                ...
                                <div class="w-full md:w-1/2 mt-8 md:mt-0 flex justify-center items-center">
                                    <div class="relative w-full max-w-xs">
                                        <div class="relative bg-teal-100 bg-opacity-10 rounded-xl p-6">
                                            <div class="flex justify-center mb-4">
                                                <div class="relative">
