      ...
      <div class="rounded-xl border border-gray-100 bg-white p-6 shadow-lg">
        <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          @foreach ($sortedCategories as $category)
            <a class="flex items-center justify-between rounded-lg border border-[#A0D3D9]/30 bg-[#F2F2F2] px-4 py-3 text-[#0B1E26] transition-all duration-200 hover:bg-white hover:shadow-md"
