  ...
  <div class="min-h-screen bg-[#F8FAFC] py-6">
    <div class="mx-auto max-w-[1280px] px-6 sm:px-8 lg:px-12">
      <div class="mb-8">
        ...
        <p class="mt-2 text-[#64748B]">探している薬の名前を入力してください</p>
      </div>
        ...
        <form class="mx-auto max-w-2xl" action="{{ route("medicines.index") }}" method="GET">
          <div class="flex items-center">
            <div class="relative flex-grow">
              ...
              <input
                class="w-full rounded-lg border border-[#E2E8F0] py-3 pl-10 pr-4 transition-all duration-200 focus:border-transparent focus:outline-none focus:ring-2 focus:ring-[#3B82F6]"
                name="query" type="text" value="{{ $query ?? "" }}" placeholder="例: パナドール、タイレノール">
            </div>
            <button
              class="ml-4 transform rounded-lg bg-[#3B82F6] px-6 py-3 text-sm font-semibold text-white shadow-md transition-all duration-200 hover:-translate-y-0.5 hover:bg-[#2563EB] hover:shadow-lg"
              type="submit">
              検索
            </button>
          </div>
