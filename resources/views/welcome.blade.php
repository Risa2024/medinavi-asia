                ...
                <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20">
                    <div class="flex flex-col md:flex-row items-center md:justify-between gap-8 md:gap-12">
                        <div class="w-full md:w-1/2 text-center md:text-left">
                            <span class="inline-block px-3 py-1 text-sm font-semibold bg-teal-50 text-teal-600 rounded-full mb-4 sm:mb-5">アジアの市販薬情報をもっと身近に</span>
                            <h1 class="text-3xl sm:text-4xl md:text-5xl font-bold leading-tight mb-4 sm:mb-6 text-slate-800">
                                MediNavi Asia
                            </h1>
                            <p class="text-lg sm:text-xl text-slate-600 mb-6 sm:mb-8">
                            ...
                            <div class="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                              <a href="{{ route('register') }}" class="bg-teal-600 text-white hover:bg-teal-700 font-semibold px-6 py-3 rounded-lg shadow-md hover:shadow-lg transition-all transform hover:scale-105 text-center">
                                ...
                                <a href="#features" class="border border-teal-200 text-teal-600 px-6 py-3 rounded-lg hover:bg-teal-50 transition-all text-center">
                                    詳しく見る
                                </a>
                            </div>
                        </div>
