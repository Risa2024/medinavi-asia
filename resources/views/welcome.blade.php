      ...
      <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        <div class="rounded-xl bg-white p-4 shadow-lg sm:p-6 md:p-8">
          ...
          <div class="space-y-3 sm:space-y-4 text-xs sm:text-sm text-slate-600">
            <p>
              1. 本サービスは情報提供サービスであり、医療に関する診断、診断の補助、診療又は治療行為のいずれにも相当しないことを十分認識するものとします。
            </p>
            <p>
            ...
            <p>
              3. 本サービスで提供する情報について、その正確性、真実性、有効性、有用性、最新性、合法性等を確保すべく細心の注意を払っておりますが、これらを保証するものではありません。
            </p>
            <p>
              4. 本サービスの提供の中断、停止、利用不能または変更、本サービスの利用によるデータの消失、機器の故障・損傷、その他本サービスに関連して利用者が被った損害につき、一切責任を負わないものとします。
            </p>
