            ...
            <section id='about' class="py-16 sm:py-24 bg-white">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex flex-col md:flex-row items-center gap-12 md:gap-16">
                        <div class="w-full md:w-1/2">
                            <span class="inline-block px-4 py-1.5 text-sm font-semibold text-slate-800 bg-teal-100 rounded-full mb-4">サービス概要</span>
                            <h2 class="text-3xl sm:text-4xl font-bold text-slate-800 mb-6 sm:mb-8">安心して市販薬を<br>探せるプラットフォーム</h2>
                            <p class="text-lg text-slate-600 mb-8 sm:mb-10 leading-relaxed">
                            ...
                            <ul class="space-y-4 sm:space-y-5">
                                <li class="flex items-center transform transition-transform duration-300 hover:translate-x-2">
                                    ...
                                    <span class="text-lg text-slate-600 ml-4">アジア各国の市販薬情報を順次拡大中</span>
                                </li>
                                <li class="flex items-center transform transition-transform duration-300 hover:translate-x-2">
                                    <div class="flex-shrink-0 w-8 h-8 bg-teal-100 rounded-full flex items-center justify-center">
                                        <svg class="h-5 w-5 text-teal-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <span class="text-lg text-slate-600 ml-4">看護師監修の安心情報</span>
                                </li>
                                <li class="flex items-center transform transition-transform duration-300 hover:translate-x-2">
                                    <div class="flex-shrink-0 w-8 h-8 bg-teal-100 rounded-full flex items-center justify-center">
                                        <svg class="h-5 w-5 text-teal-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <span class="text-lg text-slate-600 ml-4">24時間365日アクセス可能</span>
                                </li>
                            </ul>
                        </div>
                        <div class="w-full md:w-1/2">
